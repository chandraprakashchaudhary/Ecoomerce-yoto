  ...
  return (
    <div className="lg:container mx-auto p-[80px]">
      <div className="max-w-[648px] w-full min-h-[382px] p-[31px] mx-auto flex items-center justify-center flex-col rounded-lg border-[1px] border-[#9a9caa]">
        <h3 className="text-3xl text-[#bbbbc1] font-semibold font-inter mb-5 capitalize">
          Login{" "}
        </h3>
        ...
        <p className="text-base text-[#d3d1e0] font-normal font-inter flex items-center justify-center gap-2.5 mt-4">
          Don't have account{" "}
